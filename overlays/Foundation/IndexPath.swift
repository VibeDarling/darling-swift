...
// From release/5.4 stdlib/public/Darwin/Foundation/IndexPath.swift.
// Darling: NSIndexPath's accessors are methods, -getIndexes: takes no range, and bridged pairs are created with
// -initWithIndexes:length: instead of the _NSIndexPathCreateFromIndexes overlay shim.
