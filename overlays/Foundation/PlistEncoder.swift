...
fileprivate struct _PlistKeyedEncodingContainer<K : CodingKey> : KeyedEncodingContainerProtocol {
    ...
    public mutating func encodeNil(forKey key: Key)               throws { self.container.setObject(_plistNullNSString, forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: Bool, forKey key: Key)   throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: Int, forKey key: Key)    throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: Int8, forKey key: Key)   throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: Int16, forKey key: Key)  throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: Int32, forKey key: Key)  throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: Int64, forKey key: Key)  throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: UInt, forKey key: Key)   throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: UInt8, forKey key: Key)  throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: UInt16, forKey key: Key) throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: UInt32, forKey key: Key) throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: UInt64, forKey key: Key) throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: String, forKey key: Key) throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: Float, forKey key: Key)  throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }
    public mutating func encode(_ value: Double, forKey key: Key) throws { self.container.setObject(self.encoder.box(value), forKey: key.stringValue as NSString) }

    public mutating func encode<T : Encodable>(_ value: T, forKey key: Key) throws {
        self.encoder.codingPath.append(key)
        defer { self.encoder.codingPath.removeLast() }
        self.container.setObject(try self.encoder.box(value), forKey: key.stringValue as NSString)
    }
...
fileprivate let _plistNullNSString = _plistNull as NSString
