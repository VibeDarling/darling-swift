...
extension UDateFormatSymbolType {
    ...
    // Darling: narrowQuarters and standaloneNarrowQuarters are ICU 70; Darling has ICU 66.
}
...
// Darling: the UDateFormatHourCycle aliases are dropped; the type is ICU 67.
