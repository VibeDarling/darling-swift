...
// Adapted from swift-corelibs-foundation's Darwin Foundation overlay for Darling's
// Objective-C method imports and NSURLRequest's immutable copy behavior.
...
public struct URLRequest : ReferenceConvertible, Equatable, Hashable {
    ...
    public typealias CachePolicy = NSURLRequestCachePolicy
    public typealias NetworkServiceType = NSURLRequestNetworkServiceType
    ...
    */
    ...
    internal mutating func _applyMutation<ReturnType>(_ whatToDo : (NSMutableURLRequest) -> ReturnType) -> ReturnType {
        if !isKnownUniquelyReferenced(&_handle) {
            let ref = _handle._uncopiedReference().mutableCopy() as! NSMutableURLRequest
            _handle = _MutableHandle(adoptingReference: ref)
        }
    ...
    private init(_bridged request: __shared NSURLRequest) {
        _handle = _MutableHandle(adoptingReference: request.mutableCopy() as! NSMutableURLRequest)
    }
    ...
    public var cachePolicy: CachePolicy {
        ...
        set {
            _applyMutation { $0.setCachePolicy(newValue) }
        }
    }
    ...
    public var timeoutInterval: TimeInterval {
        ...
        set {
            _applyMutation { $0.setTimeoutInterval(newValue) }
        }
    }
    ...
    /// - discussion: This returns the default service type for requests that have
    ...
    public var networkServiceType: NetworkServiceType {
        ...
        set {
            _applyMutation { $0.setNetworkServiceType(newValue) }
        }
    }
    ...
    public var allowsCellularAccess: Bool {
        ...
        set {
            _applyMutation { $0.setAllowsCellularAccess(newValue) }
        }
    }
    ...
    public var allHTTPHeaderFields: [String : String]? {
        get {
            return _handle.map { $0.allHTTPHeaderFields() as? [String : String] }
        }
        set {
            _applyMutation { $0.setAllHTTPHeaderFields(newValue) }
        }
    }
    ...
    public var httpBodyStream: NSInputStream? {
        ...
        set {
            _applyMutation { $0.setHTTPBodyStream(newValue) }
        }
    }
    ...
    public var httpShouldHandleCookies: Bool {
        ...
        set {
            _applyMutation { $0.setHTTPShouldHandleCookies(newValue) }
        }
    }
    ...
    public var httpShouldUsePipelining: Bool {
        ...
        set {
            _applyMutation { $0.setHTTPShouldUsePipelining(newValue) }
        }
    }
...
extension URLRequest : _ObjectiveCBridgeable {
    ...
    public func _bridgeToObjectiveC() -> NSURLRequest {
        return _handle._uncopiedReference().copy() as! NSURLRequest
    }
