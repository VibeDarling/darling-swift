...
// AffineTransform, from release/5.4 stdlib/public/Darwin/Foundation/AffineTransform.swift.
// Darling: NSAffineTransform's transformStruct is a method pair (-transformStruct/-setTransformStruct:).
...
public struct AffineTransform : ReferenceConvertible, Hashable, CustomStringConvertible {
    ...
    */
    ...
    private var reference: NSAffineTransform {
        ...
        ref.setTransformStruct(NSAffineTransformStruct(m11: m11, m12: m12, m21: m21, m22: m22, tX: tX, tY: tY))
        return ref
    }
