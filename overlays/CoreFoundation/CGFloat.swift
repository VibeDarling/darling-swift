...
@frozen
// CGFloat moved from the CoreGraphics overlay into the CoreFoundation overlay (Swift 5.5 / macOS 12 SDK).
// Binaries built against newer SDKs import it from libswiftCoreFoundation with CoreGraphics-mangled names.
@available(macOS 10.9, iOS 7.0, watchOS 2.0, tvOS 9.0, *)
@_originallyDefinedIn(module: "CoreGraphics", macOS 12.0, iOS 15.0, watchOS 8.0, tvOS 15.0)
