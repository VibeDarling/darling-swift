...
let n200: NSNumber = NSNumber(value: 200)
let n300: NSNumber = NSNumber(value: 300)
let nMinus1: NSNumber = NSNumber(value: -1)
...
check((NSNumber(value: 1.5) as? Int) == nil, "NSNumber(1.5) as? Int fails")
check((NSNumber(value: 70000) as? Int16) == nil, "NSNumber(70000) as? Int16 fails")
check((NSNumber(value: 70000) as? Int32) == 70000, "NSNumber(70000) as? Int32")
check((NSNumber(value: Int64(1) << 40) as? UInt32) == nil, "NSNumber(2^40) as? UInt32 fails")
check((NSNumber(value: 0.5) as? Float) == 0.5, "NSNumber(0.5) as? Float")
check((NSNumber(value: 0.1) as? Float) == nil, "NSNumber(double 0.1) as? Float fails (inexact)")
check((NSNumber(value: (Int64(1) << 60) + 1) as? Float) == nil, "NSNumber(2^60+1) as? Float fails (inexact)")
check((NSNumber(value: 16) as? Float) == 16, "NSNumber(integer 16) as? Float")
check((NSNumber(value: Float.nan) as? Float)?.isNaN == true, "NaN as? Float")
check((NSNumber(value: 3) as? CGFloat) == 3, "NSNumber(3) as? CGFloat")
check((NSNumber(value: 0.1) as? CGFloat) == 0.1, "NSNumber(0.1) as? CGFloat")
check(Float(truncating: NSNumber(value: 0.1)) == Float(0.1), "Float(truncating:)")
...
check(CGFloat(exactly: NSNumber(value: 7)) == 7, "CGFloat(exactly:)")
...
let fromObjC = [NSNumber(value: 1)!, NSNumber(value: 0.25)!] as NSArray
...
let boxed: Any = NSNumber(value: UInt8(9))!
